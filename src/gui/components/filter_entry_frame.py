    ...
    def __init__(self, master, action: Action_Type | None, id: str, *args, **kwargs) -> None:
        ...
        if self.data is not None:
            if isinstance(self.data["data"], str):
                ...
                self.action_label.grid(row=0, column=1, sticky="nswe", pady=self._layout_settings["padding"], padx=[self._layout_settings["padding"], 0])
            else:
                ...
                self.type_label.grid(row=0, column=2, sticky="nswe", pady=self._layout_settings["padding"], padx=[self._layout_settings["padding"], 0])
                self.size_label = customtkinter.CTkLabel(master=self, text=str(self.data["data"]["settings"]["size"]), corner_radius=0)
                self.size_label.grid(row=0, column=3, sticky="nswe", pady=self._layout_settings["padding"], padx=[self._layout_settings["padding"], 0])
        else:
        ...
        self.delete_button.grid(row=0, column=5, sticky="nswe", pady=self._layout_settings["padding"], padx=0)
        ...
        if self.data is not None:
            if isinstance(self.data["data"], dict):
                ...
                self.edit_button.grid(row=0, column=6, sticky="nswe", pady=self._layout_settings["padding"], padx=[0, self._layout_settings["padding"]])
